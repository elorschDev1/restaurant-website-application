...
const GrillsSteaks = () => {
  return (
     <>
        <Row className="p-4 m-3">
            <Col className="d-flex certainCol" md={4}>
              <Card className="w-100 card-hover">
                   ...
                   <div className="Roasted Ribs"  id='580'><AddToCart/></div> 
                    </Card.Body>
                  </Card>  
            </Col>
             <Col className="d-flex certainCol" md={4}>
              <Card className="w-100 card-hover">
                    ...
                    <Card.Body className='d-flex flex-column'>
                     ...
                     <div className="Lobster Tails" id='700'><AddToCart/></div> 
                    </Card.Body>
                  </Card>  
            </Col>
             <Col className="d-flex certainCol" md={4}>
              <Card className="w-100 card-hover">
                   ...
                   <div className="Roasted Salmon" id='650'><AddToCart/></div> 
                    </Card.Body>
                  </Card>  
            </Col>
         </Row>
        <Row className="p-4 m-3">
             <Col className="d-flex certainCol" md={4}>
              <Card className="w-100 card-hover" id='Crab Cake'>
                    ...
                    <Card.Body className='d-flex flex-column'>
                     ...
                     <div className="Crab Cake" id='800'><AddToCart/></div>
                    </Card.Body>
                  </Card>  
            </Col>
             <Col className="d-flex certainCol" md={4}>
              <Card className="w-100 card-hover" id='Akaushi Meat'>
                  ...
                  <div className="Akaushi Meat" id='900'><AddToCart/></div> 
                    </Card.Body>
                  </Card>  
            </Col>
             <Col className="d-flex certainCol" md={4}>
              <Card className="w-100 card-hover" id='Fried Calamari'>
                    ...
                    <div className="Fried Calamari" id='750'><AddToCart/></div> 
                    </Card.Body>
                  </Card>  
            </Col>
          </Row>
